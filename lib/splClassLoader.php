...
class SplClassLoader
{
    ...
    /**
     * Sets the base include path for any class files in the namespace of this class loader.
     *
    ...
    /**
     * Gets the base include path for any class files in the namespace of this class loader.
     *
    ...
    public function loadClass($className)
    {
        if (null === $this->_namespace || $this->_namespace . $this->_namespaceSeparator === substr(
            ...
            if (false !== ($lastNsPos = strripos($className, $this->_namespaceSeparator))) {
                ...
                $fileName  =
                        str_replace($this->_namespaceSeparator, DIRECTORY_SEPARATOR, $namespace) . DIRECTORY_SEPARATOR;
            }
